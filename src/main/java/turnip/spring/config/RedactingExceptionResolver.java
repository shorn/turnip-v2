...
import turnip.service.AuthzSvc.NotAuthorizedExcepton;
import turnip.spring.security.ApiSafeException;
...
public class RedactingExceptionResolver extends AbstractHandlerExceptionResolver {
  ...
  protected ModelAndView doResolveException(
    ...
    errorJson.timeStamp = DateUtil.formatUtcDateTime(new Date(), "");
